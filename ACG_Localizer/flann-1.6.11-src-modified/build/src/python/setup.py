...
def find_path():
    lib_paths = [ os.path.abspath('/home/cs18/Documents/active-search/ACG_Localizer-master/flann-1.6.11-src-modified/build/lib'), abspath(join(dirname(dirname(sys.argv[0])), '../../../lib')) ]
